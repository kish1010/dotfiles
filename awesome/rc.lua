...
run_once("xrdb -merge /home/kishor/.Xdefaults")
...
awful.tag.seticon(active_theme .. "/widgets/cyan/cat.png", tags[s][2])
awful.tag.seticon(active_theme .. "/widgets/cyan/dish.png", tags[s][3])
awful.tag.seticon(active_theme .. "/widgets/cyan/mail.png", tags[s][4])
awful.tag.seticon(active_theme .. "/widgets/cyan/phones.png", tags[s][5])
awful.tag.seticon(active_theme .. "/widgets/cyan/pacman.png", tags[s][6])
...
local function disptemp()
    ...
    vicious.register(wifidowninfo, vicious.widgets.net, "<span color=\"#ce5666\">${eth0 down_kb}</span>", 1)

    wifiupinfo = wibox.widget.textbox()
    vicious.register(wifiupinfo, vicious.widgets.net, "<span color=\"#87af5f\">${eth0 up_kb}</span>", 1)
    ...
    local function dispip()
        ...
        f = io.popen("sh /home/kishor/.scripts/awesome/ip")
        infos = f:read("*all")
        f:close()
            ...
            awful.key({ modkey }, "b", function ()
                ...
                awful.key({ modkey, altkey }, "b", function ()
                    ...
                    awful.key({ altkey }, "b", function ()
                        ...
                        awful.key({ modkey, altkey    }, "Return", function () awful.util.spawn( "sudo urxvtc" ) end),
                        ...
                        awful.key({ modkey,        }, "e",      function () awful.util.spawn( "urxvtc -title Elinks -e elinks", false ) end),
                        awful.key({ modkey,        }, "n",      function () awful.util.spawn(music) end),
                        awful.key({ modkey, altkey }, "n",      function () awful.util.spawn( "urxvtc -title MusicInfo -e lyvi") end),
                        ...
                        awful.key({ modkey,        }, "t",      function () awful.util.spawn( "urxvtc -title Mail -e mutt", false ) end),
                        awful.key({ modkey, altkey }, "t",      function () awful.util.spawn( "urxvtc -title Feed -e newsbeuter", false ) end),
                        ...
                        awful.key({ modkey,        }, "y",      function () awful.util.spawn( "urxvtc -title Youtube -e youtube-viewer -m -C", false ) end),
                        awful.key({ modkey,        }, "a",      function () awful.util.spawn( "urxvtc -title Abook -e abook", false ) end),
                        ...
                        awful.key({ "Control"      }, "space",  function () awful.util.spawn( "urxvtc -e vim /home/luca/Desktop/thoughts.txt", false ) end),
                        awful.key({ modkey,        }, "f",      function () awful.util.spawn(cli_fileman) end),
                        awful.key({ modkey, altkey }, "f",      function () awful.util.spawn( "urxvtc -title Ranger -e sudo ranger" ) end),
                    ...
                    { rule = { class = "urxvtc", name = "saidar" },
                    properties = { tag = tags[1][6], switchtotag = true, floating = true } },

                    { rule = { class = "urxvtc", name = "Music" },
                    properties = { tag = tags[1][5], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "MusicInfo" },
                    properties = { tag = tags[1][5], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Mail" },
                    properties = { tag = tags[1][4], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Chat" },
                    properties = { tag = tags[1][4], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Torrent" },
                    properties = { tag = tags[1][3], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Feed" },
                    properties = { tag = tags[1][4], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Ranger" },
                    properties = { tag = tags[1][3], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "ranger:~" },
                    properties = { tag = tags[1][3], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Youtube" },
                    properties = { tag = tags[1][2], switchtotag = true } },

                    { rule = { name = "xcalc" },
                    properties = { tag = tags[1][6], switchtotag = true, floating = true } },

                    { rule = { class = "urxvtc", name = "Abook" },
                    properties = { tag = tags[1][4], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "Elinks" },
                    properties = { tag = tags[1][2], switchtotag = true } },

                    { rule = { class = "urxvtc", name = "http://duckduckgo.com/lite DuckDuckGo - ELinks" },
                    properties = { tag = tags[1][2], switchtotag = true } },
